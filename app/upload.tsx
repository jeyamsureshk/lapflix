...
import { ArrowLeft, UploadCloud, FileText, Check, X } from 'lucide-react-native';
...
export default function UploadScreen() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await api.uploadFile(params.path || '', pickedFile.name, file as Blob);
      setDone(true);
      setPickedFile(null);
    } catch (e) {
              ...
              >
                {uploading ? (
                  ...
                  <>
                    ...
                    <Text style={styles.uploadBtnText}>Upload to laptop</Text>
                  </>
                )}
              </Pressable>
            )}
